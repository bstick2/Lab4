...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        boolean sameCount = this.getCount().equals(otherEq.getCount());
        boolean sameWeight = this.getTotalWeight().equals(otherEq.getTotalWeight());
        boolean samePrice = this.getTotalPrice().equals(otherEq.getTotalPrice());
        boolean sameDescription = this.getDescription().equals(otherEq.getDescription());
        if (sameName && sameCount && sameWeight && samePrice && sameDescription) {
        	return true;
        }
        else {
        	return false;

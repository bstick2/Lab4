...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        if ((this.name.equals(otherEq.getName())) && (this.count == otherEq.getCount()) && (this.totalWeight == otherEq.getTotalWeight()) && (this.totalPrice == otherEq.getTotalPrice()) && (this.description.equals(otherEq.getDescription()))) {
        	return true;
        }
        else {
        	return false;
